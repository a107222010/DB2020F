        ...
        private void btnBuy_Click(object sender, EventArgs e)
        {
            if (CbuyerID != null)
            {
                if (tbxCreditRating.Text != "")
                {
                    ...
                    sqlStr = $"INSERT INTO record (RecordID, RecordDate, OrderID, CDCreditRating) Values ('{recordID}', '{recordDate}', '{orderID}', {tbxCreditRating.Text})";
                    MySqlCommand cmd = new MySqlCommand(sqlStr, conn);
                    cmd.ExecuteNonQuery();
            ...
            else if (CsellerID != null)
            {
                if (tbxCreditRating.Text != "")
                {
                    ...
                    sqlStr = $"INSERT INTO record (RecordID, RecordDate, OrderID, BuyerCreditRating) Values ('{recordID}', '{recordDate}', '{orderID}', {tbxCreditRating.Text})";
                    MySqlCommand cmd = new MySqlCommand(sqlStr, conn);
                    cmd.ExecuteNonQuery();
