...
namespace A107222008_UsedCar
{
    public partial class frmCarMenu : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(MinPrice + "/" + MaxPrice);
            ...
            if (MinPrice < MaxPrice)
            {
                if (tbxSearch.Text != "")
                {
                    ...
                    sqlStr = $"SELECT salescar.Brand AS '廠牌', salescar.CarType AS '車款', salescar.CarStyle AS '車種', carresource.CarModel AS '車型', carresource.CarDoor AS '車門數', carresource.Passenger AS '乘客數', carresource.CableControlSystem AS '變速系統', carresource.EngineDisplacement AS '排氣量', carresource.CarColor AS '車色',salescar.CarAge AS '車齡',salescar.Region AS '地區', salescar.CarDealerID AS '賣家編號', salescar.Price AS '價格' FROM salescar LEFT JOIN carresource On salescar.Brand = carresource.Brand AND salescar.CarType = carresource.CarType AND salescar.CarStyle = carresource.CarStyle WHERE salescar.Price BETWEEN {MinPrice} AND {MaxPrice} AND salescar.Brand like '{searchStr}%'";
                    mySqlDataAdapter = new MySqlDataAdapter(sqlStr, conn);
                    ds = new DataSet();
                    mySqlDataAdapter.Fill(ds);
                    dgvData.DataSource = ds.Tables[0];
                    ...
                    {
                        {
                            ...
                            {
                                sqlStr = $"SELECT salescar.Brand AS '廠牌', salescar.CarType AS '車款', salescar.CarStyle AS '車種', carresource.CarModel AS '車型', carresource.CarDoor AS '車門數', carresource.Passenger AS '乘客數', carresource.CableControlSystem AS '變速系統', carresource.EngineDisplacement AS '排氣量', carresource.CarColor AS '車色',salescar.CarAge AS '車齡',salescar.Region AS '地區', salescar.CarDealerID AS '賣家編號', salescar.Price AS '價格' FROM salescar LEFT JOIN carresource On salescar.Brand = carresource.Brand AND salescar.CarType = carresource.CarType AND salescar.CarStyle = carresource.CarStyle WHERE salescar.Price BETWEEN {MinPrice} AND {MaxPrice} AND salescar.{columnsStr[i]} like '{searchStr}%'";
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (MinPrice < MaxPrice)
            {
                ...
                if (cbxCarBrand.Text == "" && cbxCarType.Text == "" && cbxCarStyle.Text == "")
                {
                    sqlStr = $"SELECT salescar.Brand AS '廠牌', salescar.CarType AS '車款', salescar.CarStyle AS '車種', carresource.CarModel AS '車型', carresource.CarDoor AS '車門數', carresource.Passenger AS '乘客數', carresource.CableControlSystem AS '變速系統', carresource.EngineDisplacement AS '排氣量', carresource.CarColor AS '車色',salescar.CarAge AS '車齡',salescar.Region AS '地區', salescar.CarDealerID AS '賣家編號', salescar.Price AS '價格' FROM salescar LEFT JOIN carresource On salescar.Brand = carresource.Brand AND salescar.CarType = carresource.CarType AND salescar.CarStyle = carresource.CarStyle WHERE salescar.Price BETWEEN {MinPrice} AND {MaxPrice}";
                    mySqlDataAdapter = new MySqlDataAdapter(sqlStr, conn);
                    ds = new DataSet();
                ...
                else if (cbxCarType.Text == "" && cbxCarStyle.Text == "")
                {
                    sqlStr = $"SELECT salescar.Brand AS '廠牌', salescar.CarType AS '車款', salescar.CarStyle AS '車種', carresource.CarModel AS '車型', carresource.CarDoor AS '車門數', carresource.Passenger AS '乘客數', carresource.CableControlSystem AS '變速系統', carresource.EngineDisplacement AS '排氣量', carresource.CarColor AS '車色',salescar.CarAge AS '車齡',salescar.Region AS '地區', salescar.CarDealerID AS '賣家編號', salescar.Price AS '價格' FROM salescar LEFT JOIN carresource On salescar.Brand = carresource.Brand AND salescar.CarType = carresource.CarType AND salescar.CarStyle = carresource.CarStyle WHERE salescar.Brand = '{cbxCarBrand.Text}' AND salescar.Price BETWEEN {MinPrice} AND {MaxPrice}";
                ...
                else if (cbxCarStyle.Text == "")
                {
                    sqlStr = $"SELECT salescar.Brand AS '廠牌', salescar.CarType AS '車款', salescar.CarStyle AS '車種', carresource.CarModel AS '車型', carresource.CarDoor AS '車門數', carresource.Passenger AS '乘客數', carresource.CableControlSystem AS '變速系統', carresource.EngineDisplacement AS '排氣量', carresource.CarColor AS '車色',salescar.CarAge AS '車齡',salescar.Region AS '地區', salescar.CarDealerID AS '賣家編號', salescar.Price AS '價格' FROM salescar LEFT JOIN carresource On salescar.Brand = carresource.Brand AND salescar.CarType = carresource.CarType AND salescar.CarStyle = carresource.CarStyle WHERE salescar.Brand = '{cbxCarBrand.Text}' AND salescar.CarType = '{cbxCarType.Text}' AND salescar.Price BETWEEN {MinPrice} AND {MaxPrice}";
                ...
                {
                    sqlStr = $"SELECT salescar.Brand AS '廠牌', salescar.CarType AS '車款', salescar.CarStyle AS '車種', carresource.CarModel AS '車型', carresource.CarDoor AS '車門數', carresource.Passenger AS '乘客數', carresource.CableControlSystem AS '變速系統', carresource.EngineDisplacement AS '排氣量', carresource.CarColor AS '車色',salescar.CarAge AS '車齡',salescar.Region AS '地區', salescar.CarDealerID AS '賣家編號', salescar.Price AS '價格' FROM salescar LEFT JOIN carresource On salescar.Brand = carresource.Brand AND salescar.CarType = carresource.CarType AND salescar.CarStyle = carresource.CarStyle WHERE salescar.Brand = '{cbxCarBrand.Text}' AND salescar.CarType = '{cbxCarType.Text}' AND salescar.CarStyle = '{cbxCarStyle.Text}' AND salescar.Price BETWEEN {MinPrice} AND {MaxPrice}";
