...
namespace A107222008_UsedCar
{
    public partial class frmCarDealerInsert : Form
    {
        ...
        void showMySellCar()
        {
            ...
            sqlStr = $"SELECT salescar.LicensePlate AS '車牌', salescar.Brand AS '廠牌', salescar.CarType AS '車款', salescar.CarStyle AS '車型', salescar.CarAge AS '車齡', salescar.Region AS '地區', salescar.Price AS '價格'  FROM `salescar` WHERE salescar.CarDealerID = '{SellerID}'";
            mySqlDataAdapter = new MySqlDataAdapter(sqlStr, conn);
